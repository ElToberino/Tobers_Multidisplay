...
const char* ntpServer = "fritz.box";                            //"2.europe.pool.ntp.org"; //"pool.ntp.org";             // server pool prefix "2." could be necessary with IPv6
...
const String WeatherApiKey = "722d2665da932d00c4811dd440beb3b1";        // personal api key necessary for retrieving the weather data
...
const String ownCityIDs[] = {                                           // Search your city at https://openweathermap.org/ and grab the ID from URL. Example: https://openweathermap.org/city/2761369 --> ID=2761369
  "2761369",    // Wien                                            // Wien: 2761369 // Gaggenau: 2923362 
  "2643743"     // London                                        // London: 2643743 // Innsbruck: 2775220 // Mayrhofen: 2771725
  };
...
const String NewsApiKey = "bbdbc7b2b2f94b3b85618e096988ed7a";       // your personal news api key
...
const String ownNewsSources[] = {                                   // your inidividual news sources -> part of the url used for newsserver call in getNewsData(); for details see https://newsapi.org/docs
  ...
  "everything?domains=politico.eu",                                 //"everything?domains=spiegel.de"; //"everything?domains=derstandard.at";  
  "top-headlines?sources=cnn",                                      //"everything?domains=tirol.orf.at";
  "top-headlines?sources=the-washington-post"                       //"top-headlines?sources=handelsblatt";
};
...
#ifdef SPOTIFY
const char* clientID = "3d713b867e764ea39ba10e65abac23ce";                                      // register your device on https://developer.spotify.com/dashboard/
const char* clientSecret = "30ae52fc85d14a619c9f7940b98c63d9";
...
const char* www_username = "tober";                    // credendtials for html admin sites -> must be entered in browser to reach these sites
const char* www_password = "franz";                   
